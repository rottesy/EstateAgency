...
void MainWindow::handleException(const std::exception &e)
{
    ...
    {
        QMessageBox::warning(this, "Ошибка", QString("Неизвестная ошибка: %1").arg(e.what()));
    }
}
